...
class CurrencyListingResponseDesirealizer : JsonDeserializer<CurrencyListingResponse> {
    ...
    override fun deserialize(
        ...
        val priceInfo = dataJson.asJsonObject.entrySet().first().value.asJsonObject.get(
            "quote"
        ).asJsonObject.get(
            "USD"
        )
